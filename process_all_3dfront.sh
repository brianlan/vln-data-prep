...
# Process every locally materialized 3D-FRONT Zed trajectory. Git-LFS pointer
# files are skipped; no trajectory data is downloaded automatically.

SCRIPT_DIR=/home/rlan/projects/vln-data-prep
TRAJ_DIR=/ssd5/datasets/InternData-N1/vln_n1/traj_data/3dfront_zed
LOG_DIR=/tmp/opencode/3dfront_batch_logs
...
while IFS= read -r archive; do
    ...
    if bash "${SCRIPT_DIR}/run_pipeline_3dfront.sh" "$scene" \
        > "${LOG_DIR}/${scene}.log" 2>&1; then
