"""Thin generation CLI: ``python -m sage3d.cli.generate``.

Isaac-lane entry point for trajectory generation.  Parses arguments, builds
a :class:`~sage3d.config.GenerationConfig`, runs
:func:`~sage3d.trajectory_pipeline.generate`, and publishes artifacts
atomically via sibling staging + rename.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate deterministic PointGoal trajectories for SAGE3D.",
    )
